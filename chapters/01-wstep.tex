...
Celem pracy jest opracowanie aplikacji webowej \textit{Moje Konie} wykorzystującej przetwarzanie języka naturalnego do sterowania funkcjami systemu oraz analiza skuteczności zastosowanych metod klasyfikacji intencji i mapowania wypowiedzi użytkownika na żądania REST.
	...
	Szczególnie istotnym rozszerzeniem jest \textit{Sentence-BERT (SBERT)}, umożliwiający tworzenie wektorów reprezentujących całe zdania, co czyni go niezwykle użytecznym w klasyfikacji tekstu, wyszukiwaniu informacji czy dopasowaniu zapytań \cite{reimers2019sentencebert}.
    ...
    \subsection{Duże Modele Językowe i Model Gemini 2.5 Flash}
    \label{sec:llm}
    ...
    Mimo wysokiej skuteczności, LLM-y takie jak Gemini 2.5 Flash nadal wymagają dużych zasobów obliczeniowych i mogą generować nieścisłości semantyczne, znane jako \textit{halucynacje} \cite[p.~42]{bommasani2021opportunities}.
	...
	Od prostych modeli osadzania słów, przez transformery, aż po duże modele językowe — rozwój NLP umożliwia coraz bardziej naturalną interakcję człowieka z komputerem.Zastosowanie LLM, takich jak \textit{Gemini 2.5 Flash}, otwiera nowe możliwości dla aplikacji sterowanych językiem naturalnym, w tym systemu \textit{Moje Konie}, w którym polecenia użytkownika mogą być tłumaczone bezpośrednio na żądania REST w sposób kontekstowo poprawny i semantycznie spójny.
