...
\item Następnie dołączany jest dodatkowy kontekst, np. choroby koni dla końcówki \definicja{api/wydarzenia/leczenia}.
\item Opcjonalnie wstawiane są przykłady \textit{Few-Shot}, które uczą model odwzorowania typowych zapytań użytkowników na poprawne struktury JSON.
\end{enumerate}
...
api/wydarzenia/podkucie & 1 & 0,781 & 0,79 \\ \hline
api/wydarzenia/podkucie & 2 & 0,789 & 0,80 \\ \hline
api/wydarzenia/podkucie & 3 & 0,783 & 0,79 \\ \hline
api/wydarzenia/podkucie & 4 & \textbf{0,788} & \textbf{0,80} \\ \hline
api/wydarzenia/podkucie & 5 & 0,784 & 0,79 \\ \hline
\multicolumn{4}{c}{} \\ \hline
...
api/wydarzenia/zdarzenia\_profilaktyczne & 1 & 0,842 & 0,85 \\ \hline
api/wydarzenia/zdarzenia\_profilaktyczne & 2 & 0,857 & 0,86 \\ \hline
api/wydarzenia/zdarzenia\_profilaktyczne & 3 & \textbf{0,859} & \textbf{0,87} \\ \hline
api/wydarzenia/zdarzenia\_profilaktyczne & 4 & \textbf{0,859} & \textbf{0,87} \\ \hline
api/wydarzenia/zdarzenia\_profilaktyczne & 5 & 0,854 & 0,86 \\ \hline
\multicolumn{4}{c}{} \\ \hline

api/wydarzenia/leczenia & 1 & 0,677 & 0,71 \\ \hline
api/wydarzenia/leczenia & 2 & 0,683 & 0,72 \\ \hline
api/wydarzenia/leczenia & 3 & 0,698 & 0,72 \\ \hline
api/wydarzenia/leczenia & 4 & \textbf{0,701} & \textbf{0,72} \\ \hline
api/wydarzenia/leczenia & 5 & 0,698 & 0,72 \\ \hline
...
Efektywność tej strategii potwierdzają wyniki eksperymentalne dla końcówki \texttt{api/wydarzenia/\allowbreak{}leczenia}, przedstawione w Tabeli \ref{tab:wyniki_leczenia}. Zastosowanie wieloetapowej orkiestracji pozwoliło zwiększyć średnią precyzję z $0{,}70$ do $0{,}86$ oraz efektywność z $0{,}72$ do $0{,}88$. Wzrost tych wartości wskazuje, że model znacznie rzadziej popełniał błędy w przypisywaniu procedur medycznych do istniejących rekordów chorób, a generowane obiekty JSON były w większości przypadków poprawne i zgodne ze schematem.
...
Zapytanie jednokrokowe & 0,70 & 0,72 \\ \hline
