...
\label{tab:fewshot_endpoint_naturalized_rounded}
\begin{tabular}{|l|c|c|c|}
\hline
...
\begin{tabular}{|l|c|c|}
\hline
\textbf{Podejście} & \textbf{Śr. Precyzja} & \textbf{Efektywność} \ \hline
