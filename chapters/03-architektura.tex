...
% TODO: W jaki sposób zostało to uwzględnione i czy było to jakoś weryfikowane. Trzeba lepiej opisać lub usunąć fragment.
...
Infrastruktura chrmurowa jest definiowana w kodzie (\english{Infrastructure as Code}, IaC) z~wykorzystaniem narzędzi Terraform (do zapewniania zasobów chmurowych) oraz Ansible (do konfiguracji serwera), co przedstawiono na Rysunku \ref{rys:diagram-wdrozenia}.
...
\begin{description}
	...
	\item[Dodatkowo zabezpieczone obrazy kontenerów:] Aplikacje uruchamiane są w oparciu o~obrazy, takie jak \textit{Google Distroless Node.js} \cite{TODO} (dla backendu) czy \textit{Chainguard Nginx} (dla frontendu) \cite{TODO}. Obrazy te są pozbawione powłoki systemowej (shell) oraz zbędnych narzędzi, co drastycznie utrudnia atakującemu wykonanie złośliwego kodu w przypadku przełamania zabezpieczeń aplikacji.
...
% TODO: Dodać odnośniki do Google Distroless Node.js oraz Chainguard Nginx
