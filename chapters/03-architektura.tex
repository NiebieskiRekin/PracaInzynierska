...
\begin{enumerate}
    ...
    \item \textbf{Etap scalania dla backendu}: Finalny obraz uruchamiający serwer backendu rozszerzający uproszczony obraz środowiska \textit{Node.js} \cite{google_distroless} o~skompilowany kod z~pierwszej i~pliki zależności z~drugiej warstwy.
\end{enumerate}
