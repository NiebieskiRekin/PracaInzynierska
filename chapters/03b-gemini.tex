...
Pierwotna konstrukcja zapytania charakteryzowała się znaczną długością, co wynikało z konieczności zawarcia w jednym zapytaniu pełnej wiedzy o architekturze systemu. Na wykazie \ref{wyk:prompt_verbatim} przedstawiono strukturę tego zapytania, które składało się z kilku kluczowych sekcji:
...
\begin{description}
    ...
    \item[Gemini 1.5 Flash] (\english{Google}) -- model komercyjny o niskich opóźnieniach, zaprojektowany do~szybkiego przetwarzania dużych okien kontekstowych. \textbf{Typ:} Zamknięty (SaaS).
\end{description}
...
\begin{table}[h!]
\centering
\caption{Wyniki Finalnej oceny całego modelu(Model Hybdrydowy)}
\label{tab:llm_comparison1}
\begin{tabular}{|l|c|c|c|c|}
\hline
\textbf{Model} & \textbf{Skuteczność} & \textbf{Śr. Precyzja} & \textbf{Efektywność} \\ \hline
Model Hybdrydowy         & 0,85                 & 0,89                  & 0,85                 \\ \hline
\end{tabular}
\end{table}