...
\label{chapters:Klasyfikator_intencji}
...
\begin{equation}
    I_{final} = \arg\max_{i \in \text{Intencje}} \sum_{m \in \mathcal{M}} \mathbb{1}(P_m(q) = i)
\end{equation}
...
\begin{itemize}
    ...
    \item $\mathbb{1}(\cdot)$ -- funkcja wskaźnikowa przyjmująca wartość 1, gdy warunek jest spełniony.
\end{itemize}
